...
The project uses pytest for its unit tests. When in root directory use the `pytest` command to run the unit tests. There are 14 unit tests that test each api call for its success and failure responses.
